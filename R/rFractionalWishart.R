...
#'
#' @references Adhikari, S. (2008). Wishart random matrices in probabilistic structural mechanics. Journal of engineering mechanics, 134(12), doi:1029-1044.10.1061/(ASCE)0733-9399(2008)134:12(1029).
#'
#' @inherit rWishart
#' @export
#' 
